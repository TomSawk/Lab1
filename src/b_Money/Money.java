...
public class Money implements Comparable {
    ...
    public String toString() {
        double amountInDouble = (double) this.amount / 100; // Convert the amount to a decimal representation
        return String.format("%.2f %s", amountInDouble, this.currency.getName());
    }
